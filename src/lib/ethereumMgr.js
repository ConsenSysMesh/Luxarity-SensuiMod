...
class EthereumMgr {
  ...
  async makeTx(dataPayload) {
    ...
    if (dataPayload.methodName == "soldOrderToMint") {
      var payloadData = functionDef.toPayload([dataPayload.tokenURI, dataPayload.saleAmount, dataPayload.buyerID, dataPayload.redemptionHash, dataPayload.orderNumber]).data;
      console.log('\nGot the data payload ' + payloadData);
    } else if (dataPayload.methodName == "chooseDonation") {
      var payloadData = functionDef.toPayload([dataPayload.buyerID, dataPayload.charityName, dataPayload.chosenDonateAmount, dataPayload.orderNumber, dataPayload.tokenId]).data;
      console.log('\nGot the data payload ' + payloadData);
    ...
    //to = contract address
      ...
      //test contract v2 address rinkeby: 0x365e68bbbd82a639a17eed8c89ccdc5cfedbd828
      //test contract v3 address rinkeby: 0x9a183bef9cb2ce63481c4315ddb84857040a3d39
      //test contract v4 address rinkeby: 0xa4c69450f2dea4a10a7e799674feda99c9af9732
    let rawTx = {
      from: '0xfAdB0EE528E55bCb5F5Cd3e40D664a66358f5961',
      to: '0xa4c69450f2dea4a10a7e799674feda99c9af9732',
